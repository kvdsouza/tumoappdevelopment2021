...
export default class App extends React.Component {
 ...
 press1 = () => {
    this.props.navigation.navigate('Eresunyot');
  };
  press2 = () => {
    ...
    return (
      <ScrollView style={styles.viewStyle}>
        <View style={styles.mains}>
          ...
          <Text style={styles.paragraph3}>Your progress is | 10%</Text>
          ...
          <View style={styles.main6}>
            ...
            <TouchableOpacity style={styles.button2} onPress={this.press2}>
