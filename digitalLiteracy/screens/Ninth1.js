...
const App = (props) => {
  ...
  const handlePress5 = () => {
    props.navigation.navigate('Tenth1');
  };
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.question}>
          ...
          <Text style={styles.qtext}>
            {" "}Which of the following won’t protect you from phishing scams.
        ...
        <TouchableOpacity
          ...
          <Text style={styles.buttonText}>1. Click on all hyperlinks you see
</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.buttonText}>2. Be careful of suspicious messages
</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.buttonText}>3. Look whether webpage is safe and secure
</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.buttonText}>4. Keep operating system up to date
</Text>
        </TouchableOpacity>
