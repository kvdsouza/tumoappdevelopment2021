...
const App = (props) => {
  ...
  const handlePress5 = () => {
    props.navigation.navigate('EresunErku1');
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.question}>
       ...
       {" "}If someone makes you feel nervous or uncomfortable you should do the following. Choose the wrong answer
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>1. Stop communicating with them
t</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>2.Argue with them
</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>3. Tell someone you trust immediately
</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
       style={{
        ...
        <Text style={styles.buttonText}>4. Report suspicious activity
</Text>
      </TouchableOpacity>
