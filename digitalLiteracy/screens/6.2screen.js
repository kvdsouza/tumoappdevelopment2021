  ...
  render() {
    ...
    return (
      <ScrollView style={styles.container}>
        <Text style={styles.paragraph}>CHAPTER 1. THE IMPORTANCE OF NOT OVERSHARING ONLINE</Text>

        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
          <Image style={styles.icon} source={require('../images/girl3.png')} />
        </View>

        <Text style={styles.header}>Oversharing online</Text>

        <Text style={styles.body}>
        The internet and the web make it possible for us to stay connected with friends and family across the world. We can use social media and other platforms to see what's happening in our friend’s lives, share personal news, and stay in touch with others, but sharing things online, isn't always safe.
Consider this scenario, Harold gets a new car and wants his friends to see it. So, he posts a picture of it on social media. This might seem okay, but the picture includes a lot of personal information about Harold. Anyone can see his license plate number, what kind of car he's driving, and where he lives from one picture. 
 
        </Text>

        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
          <Image style={styles.pic} source={require('../images/nkarr1.png')} />
        </View>
...
Practice number one, be careful of suspicious messages. Scammers try to make their messages look official and familiar, so you trust them. Think twice when you receive a suspicious message and avoid sharing personal information over message or email. This includes your home address, bank information, passwords, and more. Don't click on a link or download a file if you don't know or trust the sender. 
             ...
             <View style={{ alignItems: 'center', justifyContent: 'center' }}>
          <Image style={styles.pic2} source={require('../images/nkarr2.png')} />
        </View>
        <Text style={styles.body}>
...
Practice number three, keep your web browser and operating system up to date. You can turn on automatic updates to make sure the latest software releases are automatically installed on your computer. Keeping your device software up to date means you will receive the latest security updates that help to protect your computer. 
     ...
     <View style={{ alignItems: 'center', justifyContent: 'center' }}>
          <Image style={styles.pic3} source={require('../images/nkarr3.png')} />
        </View>
        <Text style={styles.body}>
