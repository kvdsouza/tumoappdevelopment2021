...
const App = (props) => {
  ...
  const handlePress5 = () => {
    props.navigation.navigate('TwentyFourth2');
  };
...
How does it look?</Text>
      ...
      <Text style={styles.question}>
        ...
        <Text style={styles.qtext}>
         {" "}You should keep in mind that everything you do online becomes part of your online history, or your
        </Text>
      </Text>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>1. Digital agenda
</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>2. Digital footprint
</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>3. Digital fingertip
</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
       style={{
        ...
        <Text style={styles.buttonText}>4. Digital journal
</Text>
      </TouchableOpacity>
