...
export default class ThirdScreen extends React.Component {
  ...
  press1 = () => {
    this.props.navigation.navigate('Eresunut');
  };
 press2 = () => {
  ...
  render() {
    ...
    const name = navigation.getParam('name', ' friend :)');
      ...
      <ScrollView style={styles.viewStyle}>
        <View style={styles.mains}>
          ...
          <Text style={styles.paragraph2}>
            Now you can learn the digital literacy through the courses. Click
            below
          </Text>
          <Text style={styles.paragraph3}>Your progress is | 0%</Text>
