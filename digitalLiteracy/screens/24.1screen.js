...
const App = (props) => {
  ...
  const handlePress5 = () => {
    props.navigation.navigate('TwentyFifth1');
  };
  ...
  <ScrollView style={styles.viewStyle}>
      ...
      <Text style={styles.question}>
        ...
        {" "} Which of these tips you can't use to keep yourself safe from online predators
...
<View style={{ alignItems: 'center', justifyContent: 'center' }}>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>1. Believe to kind people in Internet
</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>2. Use your instincts
</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
       style={{
        ...
        <Text style={styles.buttonText}>3. Limit what you share
</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>4. Keep your distance
</Text>
      </TouchableOpacity>
