...
const App = (props) => {
  ...
  const handlePress5 = () => {
    props.navigation.navigate('TwentyFourth');
  };
...
PERSONAL COMPUTERS</Text>
      ...
      <Text style={styles.question}>
        ...
        <Text style={styles.qtext}>
         {" "}Which of these devices is not a computer? Choose only one option.
        </Text>
      </Text>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>1. A desktop</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>2. A monitor</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>3. A laptop</Text>
      </TouchableOpacity>
